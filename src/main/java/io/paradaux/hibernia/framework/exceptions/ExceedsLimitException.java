...
public class ExceedsLimitException extends RuntimeException implements KeyedException {
    ...
    public ExceedsLimitException(String messageKey) {
        super(messageKey);
        this.placeholders = Map.of();
    }

    /** As {@link #ExceedsLimitException(String)} with {@code key, value, …} placeholder pairs. */
    public ExceedsLimitException(String messageKey, Object... placeholders) {
        super(messageKey);
